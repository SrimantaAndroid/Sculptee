...
class DropDownWeightListAdapter(
    val homeActivity: CartActivity?,
    val list:ArrayList<String>?,
    val onItemClickInterface: OnItemClickInterface) : RecyclerView.Adapter<DropDownWeightListAdapter.ViewHolder>() {
    var  deviceResolution: DeviceResolution?=null
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DropDownWeightListAdapter.ViewHolder {
